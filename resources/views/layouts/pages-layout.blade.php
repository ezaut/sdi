            ...
            <div class="user-info-dropdown">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            ...
                            <a class="dropdown-item" href="{{ route('user.logout_handler') }}" onclick="event.preventDefault();document.getElementById('candidatoLogoutForm').
								    submit();"><i class="dw dw-logout"></i> Log Out</a>
                            <form action="{{ route('user.logout_handler') }}" id="userLogoutForm" method="POST">
                                @csrf</form>
                        </div>
                    </div>
                </div>
